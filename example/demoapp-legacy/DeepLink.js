...
const DeepLink = ({ route }) => {
    ...
    if (!link) {
        return (
            <View style={styles.container}>
                <Text style={styles.title} testID="deep-link-empty">No deep link yet</Text>
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style={styles.url} testID="deep-link-url">{link}</Text>
...
const Row = ({ label, value }) => (
    <View style={styles.row}>
        ...
        <Text style={styles.rowValue} testID={`deep-link-${label}`}>{value}</Text>
    </View>
);
